...
* **Algebra**: Algebraic operations and equations.
* **Analytical Geometry**: Coordinate-based geometry.
* **Counting**: Combinatorics, including permutations and combinations.
* **Geometry**: 2D geometric calculations (area, perimeter, etc.).
* **Stereometry**: 3D geometry and spatial calculations.
* **Number Theory**: Algorithms for primes, divisors, and modular arithmetic.
